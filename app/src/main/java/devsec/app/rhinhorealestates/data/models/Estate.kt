...
data class Estate(@SerializedName("_id")
    ...
    {
        val images = listOf(
            "http://192.168.1.136:9090/img/"+image,
            "http://192.168.1.136:9090/img/"+image1,
            "http://192.168.1.136:9090/img/"+image2,
            "http://192.168.1.136:9090/img/"+image3,
            "http://192.168.1.136:9090/img/"+image4
        )
        ...
        this("",name,area,category, description, image,image1,image2,image3,image4, isCoastal,surface,"","",ArrayList<String>(),0,0,ArrayList<String>(),ArrayList<String>(),
