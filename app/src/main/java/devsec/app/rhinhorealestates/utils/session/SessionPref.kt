...
class SessionPref {
    ...
    fun createRegisterSession(id: String, username: String, email: String, password: String,address : String, phone: String,image:String)
    {
        editor.putBoolean(IS_LOGGED_IN, true)
    ...
    fun getUserPref(): HashMap<String, String> {
        ...
        user.put(USER_ADDRESS, pref.getString(USER_ADDRESS,"address")!!)
...
//        user.put(USER_IMAGE, pref.getString(USER_IMAGE, null)!!)
    ...
    fun setUserPref(username: String, email: String, password: String,address : String, phone: String)
    {
        editor.putString(USER_NAME, username)
        editor.putString(USER_EMAIL, email)
        editor.putString(USER_PASSWORD, password)
